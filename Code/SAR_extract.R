...
# if you want to convert it to a matrix / data frame with row names
bird_df = as.data.frame(bird_df)
row.names(bird_df) = bird_df$plotID
bird_df$plotID = NULL
